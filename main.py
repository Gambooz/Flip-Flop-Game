...
GAME_SPRITES = {}
GAME_SOUNDS = {}
PLAYER = 'gallery/sprites/bird6.png'
    ...
    while True:
        for event in pygame.event.get():
            if event.type == QUIT or (event.type==KEYDOWN and event.key == K_ESCAPE):
                ...
                SCREEN.blit(GAME_SPRITES['base'], (basex+ 2*GAME_SPRITES['base'].get_width(), GROUNDY))
...
def mainGame():
    ...
    upperPipes = [
        ...
        {'x': SCREENWIDTH+200+(SCREENWIDTH*2/3), 'y':newPipe3[0]['y']},
    ]
    # my List of lower pipes
    lowerPipes = [
        {'x': SCREENWIDTH+200, 'y':newPipe1[1]['y']},
        {'x': SCREENWIDTH+200+(SCREENWIDTH/3), 'y':newPipe2[1]['y']},
        {'x': SCREENWIDTH+200+(SCREENWIDTH*2/3), 'y':newPipe3[1]['y']},
    ]
...
def getRandomPipe():
    ...
    pipeHeight = GAME_SPRITES['pipe'][0].get_height()
    offset = 150
    y2 = offset + random.randrange(0, int(SCREENHEIGHT - GAME_SPRITES['base'].get_height()  - 1.35 *offset))
...
if __name__ == "__main__":
    ...
    GAME_SPRITES['tap'] =pygame.image.load('gallery/sprites/tap3.png').convert_alpha()
    GAME_SPRITES['base'] =pygame.image.load('gallery/sprites/base.png').convert_alpha()
    GAME_SPRITES['welcome'] =pygame.image.load('gallery/sprites/welcome3.png').convert_alpha()
